...
Register cpu_ir_set_ir(CPU_IR_p ir);
Register cpu_ir_get_ir(CPU_IR_p ir);
Register cpu_ir_set_opcode(CPU_IR_p ir);
Register cpu_ir_get_opcode(CPU_IR_p ir);
Register cpu_ir_set_rd(CPU_IR_p ir);
Register cpu_ir_get_rd(CPU_IR_p ir);
Register cpu_ir_set_rs(CPU_IR_p ir);
Register cpu_ir_get_rs(CPU_IR_p ir);
Register cpu_ir_set_immed7(CPU_IR_p ir);
